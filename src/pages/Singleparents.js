                                    ...
                                    <div className='container'>
                                        ...
                                        BECOMING A PARENT THROUGH SURROGACY STARTS HERE
                                                ...
                                                <p style={{ fontSize: '17PX', marginTop: '10px', fontWeight: 100, wordSpacing: '2PX' }}>
                                                    ...
                                                    These days, you don’t have to wait until you find a long-term partner to have the experience
                                                    of parenthood. Many people decide that they want to become parents without having to get married or
                                                    go through the personal experience of pregnancy.
                                                    <br />  <br />
                            ...
                            <div className="">
                                <div className="row" data-container="container">
                                    <div
                                        ...
                                        style={{
                                            backgroundImage:
                                                "url(../mt-demo/109600/109604/mt-content/uploads/2020/07/blg.jpg)",
                            ...
                            <div className='container'>
                                <div class="card" style={{ padding: '20PX', boxShadow: 'rgba(149, 157, 165, 0.2) 0px 8px 24px' }}>
                                    <div class="card-body">
                                        ...
                                        <b style={{ fontSize: '20px' }}>SINGLE-PARENT SURROGACY PROCESS</b>
                                        <p style={{ fontSize: '20PX', marginTop: '10px', fontWeight: 100, wordSpacing: '2PX' }}>

                                            If you’re new to the concept of surrogacy, you should know that becoming an intended parent as
                                            a single person isn’t that different from the surrogacy process for couples. That is, you’ll
                                            need to find a surrogacy agency that can provide great support for you and feels like a good
                                            fit. The agency will confirm that you can afford to pay the costs for the surrogacy journey.
                                            Once you meet these requirements, you can work with the agency to match with a surrogate.

                                            When you search for agencies, you should make sure that the agency you
                                            choose has experience with surrogacy for singles. If the agency works with
                                            surrogates in locations that increase restrictions on single parenthood, you may want
                                            to ask how they can help you work toward an ideal result.
                                            <br />  <br />
                                            <b style={{ fontSize: '20px' }}> SINGLE-PARENT SURROGACY LAWS</b>
                                            <br />  <br />
                                            For the most part, you can expect single-parent surrogacy laws to be similar to surrogacy laws for couples.
                                            Of course, surrogacy laws are relatively new in many places, including the United States. Shifting options and
                                            attitudes for surrogacy means that laws can differ significantly from one state to another. It’s important to
                                            consider the laws of the surrogate’s resident state and to talk with legal experts who understand the laws in
                                            that location.
