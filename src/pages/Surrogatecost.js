                            ...
                            <div className="">
                                <div className="row" data-container="container">
                                    <div
                                        ...
                                        style={{
                                            backgroundImage:
                                                "url(../mt-demo/109600/109604/mt-content/uploads/2020/07/1.png)",
                                            backgroundPosition: "top",
                                            backgroundRepeat: "no-repeat",
                                            backgroundSize: "cover"
                                        }}
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                ...
                                                                <p className="moto-text_system_12" style={{ fontSize: '17px', wordSpacing: '2px', }}>
                                                                    In order to provide our Intended Parents with a qualified and reliable Surrogate,
                                                                    ISC helps facilitate a number of screenings and processes on your behalf. The fees below
                                                                    cover the costs of these screenings. Please contact us for more details!
                            ...
                            <div className='container'>
                                <div class="card" style={{ padding: '20PX', boxShadow: 'rgba(149, 157, 165, 0.2) 0px 8px 24px' }}>
                                    <div class="card-body">
                                        ...
                                        <b style={{ fontSize: '20px' }}> SCREENING FEES</b>
                                        <p style={{ fontSize: '20PX', marginTop: '10px', fontWeight: 100, wordSpacing: '2PX' }}>
                                            ...
                                            Background screening for surrogate and husband/boyfriend/partner. In some cases, we also include other adults living in the household

                                            Mental health screening for surrogate and husband/boyfriend/partner
                                            <br /> <br />
                                            <h1 style={{ fontSize: '20px', color: '#d83233' }}>Surrogate screenings: $1,500.00</h1>
                                            <br />
                                            ...
                                            <br />
                                            <br />
                                            <h1 style={{ fontSize: '20px', color: '#d83233' }}> Intended parent screenings: $1,100.00</h1>
                                            <br />
                                            <h1 style={{ fontSize: '20px', color: '#d83233' }}> Total screening fees due at matching: $2,600.00</h1>
                                            <br />
                                            <br />


                                            <h1 style={{ fontSize: '25px', }}> SURROGACY AGENCY FEES</h1>
                                            Agency management fee:

                                            This fee is due once the Surrogate has passed criminal, mental health, and medical
                                            screening and is non-negotiable. This is for ONE SURROGATE match only. In the event,
                                            your surrogate voluntarily or involuntarily discontinues her participation in the surrogacy
                                            process prior to completing the first embryo transfer or if the surrogate is medically denied
                                            (before completing the first embryos transfer) ISC will rematch the Intended Parents with a
                                            new surrogate without an additional agency management fee.

                                            If you want to switch your Surrogate after an unsuccessful embryo transfer/s (this also includes for medical reasons)
                                            the agency fee for a new Surrogate is $25,000.00 (to be paid once the new surrogate is medically cleared).
                                            We will only honor this fee for only one surrogate switch.
                                            <br /><br />
                                            <h1 style={{ fontSize: '20px', color: '#d83233' }}>Agency retainer fee (surrogate) $45,000</h1>

                                            <br />  
                                            (Optional) Loss protection coverage program:

                                            This additional program allows you, the client, the ability to change surrogates as many
                                             times as needed.  The fee for this program, if elected, is due once the Surrogate has passed 
                                             the criminal, psychological and medical screening and is non-negotiable and not refundable.  
                                             This is only valid for 3 years.

                                            <br />  
                                            <br /> 
                                            <h1 style={{ fontSize: '20px', color: '#d83233' }}>Loss protection fee – $5,000</h1>
