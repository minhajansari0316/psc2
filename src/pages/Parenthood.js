                                    ...
                                    <div className='container'>
                                        ...
                                        BECOMING A PARENT THROUGH SURROGACY STARTS HERE
                                                ...
                                                <p style={{ fontSize: '17PX', marginTop: '10px', fontWeight: 100, wordSpacing: '2PX' }}>
                                                    ...
                                                    Embarking on the extraordinary journey to parenthood through surrogacy is a testament to the boundless
                                                    love and unwavering hope that defines your path. It’s a story of dreams taking flight, woven with threads
                                                    of courage, trust, and the remarkable strength of the human spirit. From the moment you set your sights
                                                    on this remarkable path, you become pioneers of a unique narrative, one that champions the beauty of
                                                    collaboration and the incredible selflessness of your chosen surrogate.
                                                    <br />  <br />
                            ...
                            <div className="">
                                <div className="row" data-container="container">
                                    <div
                                        ...
                                        style={{
                                            backgroundImage:
                                                "url(../mt-demo/109600/109604/mt-content/uploads/2020/07/5.jpg)",
                                            backgroundPosition: "top",
                                            backgroundRepeat: "no-repeat",
                                            backgroundSize: "cover"
                                        }}
                            ...
                            <div className='container'>
                                <div class="card" style={{ padding: '20PX', boxShadow: 'rgba(149, 157, 165, 0.2) 0px 8px 24px' }}>
                                    <div class="card-body">
                                        ...
                                        <b style={{ fontSize: '20px' }}>1. PRESENTATION OF THE AGENCY</b>
                                        <p style={{ fontSize: '20PX', marginTop: '10px', fontWeight: 100, wordSpacing: '2PX' }}>

                                            After receiving a welcome email from ISC with some informative documents attached, your
                                            first step is a consultation with one of our agency staff. During our presentation, we discuss
                                            the steps for surrogacy, our services, recommendations for attorneys or clinics if needed, and our
                                            fees, before answering any questions you may have. Based on the circumstances, this presentation takes
                                            place either in person, through Skype or over the phone — but always at your convenience.
                                            <br />  <br />
                                            <b style={{ fontSize: '20px' }}> 2. MATCHING WITH YOUR SURROGATE</b>
                                            <br />  <br />

                                            After deciding that you are ready to proceed, the second step is to select the surrogate with whom you feel most comfortable.
                                            We send you information about a few choices that we feel most closely match your preferences. If you do not find one you like,
                                            we will either send additional profiles or wait until we have a surrogate that best matches your desires.

                                            If you like a surrogate’s profile, please let us know within 24 hours. Once we send a profile to you,
                                            we “reserve” that surrogate for you for 24 hours. If we do not hear from you, we will assume you are not interested,
                                            and she will be made available to other intended parents. If you are interested in a surrogate’s profile, we contact
                                            the surrogate and share your profile with her. If she is interested in your profile, we set up a Skype or in-person meeting so
                                            you all get to know one another.
                                            <br />  <br />
                                            <b style={{ fontSize: '20px' }}> 3. MEETING THE SURROGATE</b>
                                            <br />  <br />

                                            The third step is to meet the surrogate, either in person or through Skype. Both
                                            parties ask questions to get an idea of how each person feels about the process and
                                            to get to know one another better. Once you have met and decided that you want to work
                                            with the surrogate, you send us an email confirming that you want to match with her,
                                            and we will ask her to do the same. If both parties agree, we consider you matched.

                                            <br />  <br />
                                            <b style={{ fontSize: '20px' }}> 4. ESTABLISH CLIENT OR ESCROW ACCOUNT TO HOLD YOUR FUNDS</b>
                                            <br />  <br />
                                            ...
                                            We send a referral to the criminal background agency to do a background check on your surrogate and
                                            her spouse/partner (if applicable). We send a referral to our psychologist who will screen your surrogate
                                            and her spouse/partner (if applicable). We notify the attorney you have chosen to represent you, and we
                                            notify the matching surrogate’s attorney.
                                            <br />  <br />
                                            <b style={{ fontSize: '20px' }}>6. CRIMINAL BACKGROUND AND PSYCHOLOGICAL EXAMINATION OF THE SURROGATE</b>
                                            <br />  <br />

                                            We submit the information provided by the surrogate for a criminal background of her and her
                                            spouse/partner (if applicable) to ensure that she does not have a criminal record. Following
                                            that, the surrogate undergoes a mental health screening to confirm that she is mentally
                                            stable to become a surrogate.

                                            The intended parents are required to undergo a criminal background and mental health
                                            consultation as well. This step must be completed prior to your surrogate’s medical clearance,
                                            and the results submitted to us via email
                                            <br />  <br />
                                            <b style={{ fontSize: '20px' }}>7. MEDICAL EXAMINATION OF THE SURROGATE</b>
                                            <br />  <br />
                                            We submit your surrogate’s mental health screening result to the in vitro fertilization (IVF)
                                            clinic as soon as we receive it so her medical screening appointment can be scheduled. The
                                            IVF clinic contacts your surrogate and schedules her medical screening appointment based on
                                            where she is in her menstrual cycle.
                                            <br />  <br />
                                            <b style={{ fontSize: '20px' }}>8. PURCHASING HEALTH INSURANCE FOR YOUR BABY/BABIES</b>
                                            <br />  <br />
                                            Your surrogate’s health insurance covers her health care only throughout the surrogacy.
                                             It does not cover the baby (or babies) after birth. You have two options: (1) you can pay
                                              the hospital directly for the baby’s medical costs, or (2) you can purchase a separate health 
                                              insurance policy for the baby/babies.

                                            Since insurance is not our area of expertise, we highly suggest that you contact our 
                                            insurance specialist for more information. Your attorney will also give you information 
                                            regarding insurance for your baby/babies and can help you negotiate prices with the hospital.
                                            <br />  <br />
                                            <b style={{ fontSize: '20px' }}>9. SIGNING OF THE CONTRACT BY SURROGATE AND INTENDED PARENT(S)</b>
                                            <br />  <br />
                                            After your surrogate is medically cleared by your IVF doctor, we notify your 
                                            attorney that you are ready to review the legal contract that he/she has prepared for you 
                                            and your surrogate. Both parties and their respective lawyers review the contract before
                                             signing it. Once the contract is agreed upon by both parties, you must have the final contract
                                             notarized.
                                             <br />  <br />
                                            <b style={{ fontSize: '20px' }}>10. DEPOSIT TO THE TRUST ACCOUNT</b>
                                            <br />  <br />
                                            Within 7 days after signing the surrogacy contract, you are required to
                                             deposit $65,000 USD (for a first time surrogate) into your trust/escrow account to 
                                             cover your surrogate’s compensation. Please note that the exact initial deposit amount 
                                             may vary based upon the surrogate’s location and surrogacy experience. You may deposit an 
                                             extra amount of money to cover the cost of the egg donor cycle (if applicable), IVF doctor 
                                             specializing in infertility and/or any other expenses.
