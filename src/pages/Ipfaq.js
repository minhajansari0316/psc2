                            ...
                            <div className='container'>
                                <div class="card" style={{ padding: '20PX', boxShadow: 'rgba(149, 157, 165, 0.2) 0px 8px 24px' }}>
                                    <div class="card-body">
                                        ...
                                        How long does the surrogacy process take? Should we consider egg donation? We’ve been in this field for a while, 
                                        and we’ve heard it all. Here are answers to the questions we are asked most often by our intended parent(s).
                                            <br />  <br />
                    ...
                    <div className="">
                        <div className="row" data-container="container">
                            <div
                                ...
                                style={{
                                    backgroundImage:
                                        "url(../mt-demo/109600/109604/mt-content/uploads/2020/07/1.jpeg)",
                                    backgroundPosition: "top",
                                    backgroundRepeat: "no-repeat",
                                    backgroundSize: "cover"
                                }}
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        How long does the surrogacy process take? Should we consider egg donation? 
                                                        We’ve been in this field for a while, and we’ve heard it all. Here are answers 
                                                        to the questions we are asked most often by our intended parent(s). If you don’t
                                                         see your question on this page, feel free to contact us. We’re happy to help! 
                                                            <br /><br />
                    ...
                    <div className='container'>
                        <div class="card" style={{ padding: '20PX', boxShadow: 'rgba(149, 157, 165, 0.2) 0px 8px 24px' }}>
                            <div class="card-body">
                                ...
                                <b style={{ fontSize: '20px' }}> HOW LONG WILL IT TAKE TO FIND A SURROGATE?</b>
                                <p style={{ fontSize: '20PX', marginTop: '10px', fontWeight: 100, wordSpacing: '2PX' }}>

                                A good estimate is 2 – 4 months (depending on your surrogate criteria). 
                                In some cases, the process can be completed is as little as a few weeks.
                                    <br />  <br />
                                    <b style={{ fontSize: '20px' }}>DO WE HAVE TO PAY A DEPOSIT TO VIEW SURROGATE PROFILES?</b>
                                    <br />  <br />
                                    No. We don’t charge an agency fee or a deposit until the surrogate is medically cleared by the IVF doctor.
                                    <br />  <br />
                                    <b style={{ fontSize: '20px' }}>WHAT SCREENINGS ARE PERFORMED ON THE SURROGATE PRIOR TO MATCHING?</b>
                                    <br />  <br />

                                    Criminal background checks are performed on both the surrogate 
                                    and her partner (if applicable). The surrogate also undergoes a mental 
                                    and physical health screening

                                    <br />  <br />
                                    <b style={{ fontSize: '20px' }}> WHERE ARE THE SURROGACY FUNDS HELD?</b>
                                    <br />  <br />

                                    Your approved attorney, escrow company or a third-party fund holder is responsible for holding your funds.

                                    <br />  <br />
                                    <b style={{ fontSize: '20px' }}>WHEN DO I HAVE TO SIGN THE AGENCY RETAINER AGREEMENT?</b>
                                    <br />  <br />

                                    The agreement must be signed before the matching process begins and we share any surrogate profiles.
                                     The actual agency fee is due upon medical clearance.
                                    <br />  <br />
                                    <b style={{ fontSize: '20px' }}>DO SURROGATES HAVE THEIR OWN INSURANCE THAT COVERS SURROGACY?</b>
                                    <br />  <br />

                                    Approximately 20% of our surrogates have health insurance that covers surrogacy.
                                    <br />  <br />
                                    <b style={{ fontSize: '20px' }}>CAN WE PURCHASE AN INSURANCE POLICY FOR THE SURROGATE IF SHE IS NOT COVERED UNDER HER OWN?</b>
                                    <br />  <br />
