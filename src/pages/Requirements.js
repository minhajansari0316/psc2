                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        What all our surrogacy requirements have in common is how important they are to making the experience positive, life-changing and
                                                         able to result in an extraordinary outcome, for yourself and the intended parents. Our surrogates are loving and 
                                                        caring people who want to help other families grow. They are mothers themselves and understand the joy that children bring to a family.
                                                            <br /><br />
                                    ...
                                    <div className='container'>
                                        <div class="card" style={{ padding: '20PX', boxShadow: 'rgba(149, 157, 165, 0.2) 0px 8px 24px' }}>
                                            <div class="card-body">
                                                ...
                                                From a medical health standpoint, there are a variety of surrogate qualifications that participants must 
                                                meet, regarding age, weight, past pregnancies and lifestyle habits. These include:
                                                    <br />  <br />
                                                    <ul style={{padding:'20px'}}> 

                                                        <li>Being between the ages of 21-40</li>
                                                        <li style={{marginTop:'10px'}}>A BMI no higher than 33</li>
                                                        <li style={{marginTop:'10px'}}>A history of giving birth to and now be raising at least one child of your own</li>
                                                        <li style={{marginTop:'10px'}}>No major complications during previous pregnancies or deliveries</li>
                                                        <li style={{marginTop:'10px'}}>NON-smoker</li>
                                                        <li style={{marginTop:'10px'}}>NOT taking any illegal substances or medications that have not been prescribed by a physician</li>
                                                    </ul>
                                                    There are additional requirements beyond the physical,
                                                     too. In order to serve as a surrogate with ISC, you also need to fit the following characteristics:
                                                     <ul style={{padding:'20px'}}>

                                                        <li style={{marginTop:'20px'}}>U.S. citizen or permanent resident</li>
                                                        <li style={{marginTop:'10px'}}>Have a positive support system to help you throughout the surrogacy</li>
                                                        <li style={{marginTop:'10px'}}>Reliable transportation for appointments</li>
                                                        
                                                    </ul>
                                                    If you have any questions about surrogacy or the requirements of becoming a surrogate, please don’t hesitate to contact
                                                     one of our offices. We are happy to clarify and discuss any concerns that you 
                                                     may have prior to taking the next step. For those that
                                                     meet the surrogate requirements and would like to move forward with our program, we invite you to fill out our initial contact form.
