...
ABOUT US
        ...
        SERVICES TO HELP
                                                                            ...
                                                                            <p className="moto-text_system_4">
                                                                                SURROGACY SERVICES FOR INTERNATIONAL PARENTS
                                                                            </p>
                            ...
                            <div className="">
                                <div className="row" data-container="container">
                                    <div
                                        ...
                                        style={{
                                            backgroundImage:
                                                "url(../mt-demo/109600/109604/mt-content/uploads/2020/07/3.jpg)",
                                            backgroundPosition: "top",
                                            backgroundRepeat: "no-repeat",
                                            backgroundSize: "cover"
                                        }}
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                <h1 className="moto-text_system_7">
                                                                    WHY CHOOSE A U.S. SURROGACY AGENCY?
                                                                </h1>
                                                                ...
                                                                <p className="moto-text_system_12" style={{ fontSize: '17px', wordSpacing: '2px', }}>
                                                                    As part of our surrogacy services for international parents, our surrogates undergo thorough
                                                                    medical and mental health screenings. You can rest easy knowing that they get the best health care in
                                                                    the world and have access to advanced medicine and top facilities. With medical offices and hospitals widely
                                                                    available, our surrogates can remain at home during most of the pregnancy, assisted by loving and supportive
                                                                    family members. When your child is born here, he or she is automatically a U.S. citizen, gets a U.S. birth
                                                                    certificate and may obtain a U.S. passport with which to travel home safely. American lawyers will work on your
                                                                    behalf to establish your parental rights with either a pre- or post-birth parentage order.

                                                                    The U.S. banking system is one of the most secure in the world. And ISC works with you to set up a bonded escrow account
                                                                    at a secure financial institution to protect your savings during the surrogacy process. You can also open a client account
                                                                    with one of our trusted attorneys that manage and act as fiduciaries. We are very careful with this option.
                                                                    <br /><br />
                            ...
                            <div className='container'>
                                <div class="card" style={{ padding: '20PX', boxShadow: 'rgba(149, 157, 165, 0.2) 0px 8px 24px' }}>
                                    <div class="card-body">
                                        ...
                                        <b style={{ fontSize: '28px' }}>THE LOGISTICS OF INTERNATIONAL SURROGACY PROGRAMS</b>
                                        <p style={{ fontSize: '20PX', marginTop: '10px', fontWeight: 100, wordSpacing: '2PX' }}>
                                            You won’t have to move to the U.S., but you may want to make several trips here in addition to the required trip 
                                            to be here during the birth. You may want to meet the ISC team and your surrogate in person. You may want to be here
                                             during the embryo transfer. You are permitted to attend as many of your surrogate’s medical appointments as you wish; 
                                             most intended parents want to be present during the 20-week ultrasound scan. And the most important — and longest — visit 
                                             takes place during and after your baby’s delivery.

                                            Most of our intended parents remain in the U.S. for at least a couple of weeks after the birth. 
                                            You will make sure the birth certificate is correctly issued, apply for your baby’s passport and 
                                            take care of any issues that may arise. Don’t worry if all this sounds daunting; we help you through 
                                            the process every step of the way.
                                            <br />  <br />
                                            <b style={{ fontSize: '28px' }}>WHY INTERNATIONAL PARENTS COME TO EXPERIENCE SURROGACY IN THE UNITED STATES</b>
                                            <br />  <br />

                                            The United States is one of the most popular choices to experience surrogacy services for international parents. 
                                            This is due in large part to favorable legal and medical conditions. Commercial surrogacy for foreigners is allowed 
                                            in 47 out of 50 states, making the process easy virtually anywhere in the country.
                                            <br />  <br />
                                            <b style={{ fontSize: '28px' }}>WHAT IS THE DIFFERENCE BETWEEN INTERNATIONAL AND DOMESTIC SURROGACY?</b>
                                            <br />  <br />

                                            In addition to the obvious distinction between domestic and international surrogacy programs,
                                             there are a number of legal and procedural differences that surrogates and intended parents 
                                             must navigate. As an experienced international surrogacy agency, we have the expertise
                                              necessary to help you understand your obligations and how to take care of them in the most 
                                              efficient and successful manner.

                                            <br />  <br />
                                            <b style={{ fontSize: '28px' }}>HOW MANY VISITS WILL I HAVE TO MAKE TO THE UNITED STATES?</b>
                                            <br />  <br />

                                            Under most circumstances, intended parents will need to make about two visits to the United States during the process.
                                             This includes a visit for the IVF procedure and embryo transfer and for the birth of the child.

                                            <br />  <br />
                                            <b style={{ fontSize: '28px' }}>A FEW LAST WORDS</b>
                                            <br />  <br />
...
export default Internationaparent
