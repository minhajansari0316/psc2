                                    ...
                                    <div className='container'>
                                        <div class="card" style={{ padding: '20PX', boxShadow: 'rgba(149, 157, 165, 0.2) 0px 8px 24px' }}>
                                            <div class="card-body">
                                                ...
                                                If you think you are ready to become a parent, please complete our intended parent application form below to begin the journey to 
                                                parenthood.
                                                 An International Surrogacy Center team member will reach out shortly with additional information for qualified candidates. 
                                                    <br />  <br />
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        Have you been thinking about what a good parent you would be? About how much love and support you have to give a child? About how much you really want to 
                                                        start or grow your family? At International Surrogacy Center (ISC), we help you understand the surrogacy process so you can make an informed decision. 
                                                        And when you decide to go ahead, we’re here to steer you through the exciting journey to parenthood.
                                                            <br /><br />

                                                            We get to know you and your desires so we can match you with the perfect surrogate and/or egg donor. We help you find the legal and medical professionals you need,
                                                             and we assist you with managing and disbursing funds. ISC staff members make sure you are as involved as you wish in every step of the process — from finding a surrogate to learning the results of every medical appointment. 
                                                            We want you to feel comfortable with your decision and thoroughly enjoy the happiest time of your life!
                                                            <br/><br/>
          ...
          >
            ...
            guided so far
                                    ...
                                    <div className='container'>
                                        <div class="card" style={{ padding: '20PX', boxShadow: 'rgba(149, 157, 165, 0.2) 0px 8px 24px' }}>
                                            <div class="card-body">
                                                ...
                                                <br />
                                                <div className='col-lg-12'>
                                                    <label style={{fontSize:'20px'}}>Parent 1 - First Name: *</label>
                                               <input type='text' className='form-control'  style={{height:'45px'}}/>
                                               </div>
                                               <div className='col-lg-12'>
                                                    <label style={{fontSize:'20px'}}>Parent 1 - Last Name: *</label>
                                               <input type='text' className='form-control'  style={{height:'45px'}}/>
                                               </div>
                                               <div className='col-lg-12'>
                                                    <label style={{fontSize:'20px'}}>Parent 2 - First Name:</label>
                                               <input type='text' className='form-control'  style={{height:'45px'}}/>
                                               </div>
                                               <div className='col-lg-12'>
                                                    <label style={{fontSize:'20px'}}>Parent 2 - Last Name:</label>
                                               <input type='text' className='form-control'  style={{height:'45px'}}/>
                                               </div>
                                               <div className='col-lg-12'>
                                                    <label style={{fontSize:'20px'}}>Country: *</label>
                                               {/* <input type='text' className='form-control'  style={{height:'45px'}}/> */}
                                               <select className='form-control'  style={{height:'45px', fontSize:'16px'}}>
                ...
                <option value="Zimbabwe">Zimbabwe</option>
                                               ...
                                               <div className='col-lg-12'>
                                                    <label style={{fontSize:'20px'}}>Embryos Status: *</label>
                                              
                                               <select className='form-control'  style={{height:'45px',fontSize:'16px'}}>
                                                <option>Have embryos ready</option>
                                                <option>Actively in the process of creating embryos</option>
                                                <option>Looking for an egg donor</option>
                                               </select>
                                               </div>
                                               <div className='col-lg-12'>
                                                    <label style={{fontSize:'20px'}}>Are you currently working with an IVF clinic: *</label>
                                               ...
                                               <div className='col-lg-12'>
                                                    <label style={{fontSize:'20px'}}>Were you referred by someone?: *</label>
