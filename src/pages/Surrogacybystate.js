                                        ...
                                        <div class="card" style={{ padding: '20PX', boxShadow: 'rgba(149, 157, 165, 0.2) 0px 8px 24px' }}>
                                            <div class="card-body">
                                                ...
                                                <p style={{ fontSize: '17PX', marginTop: '10px', fontWeight: 100, wordSpacing: '2PX' }}>
                                                    ...
                                                    Laws are sometimes practiced in ways that differ from how they are written. We suggest that even if a state’s laws appear to favor surrogacy,
                                                    you should consult with an attorney who practices surrogacy law
                                                    <br />  <br />
                            ...
                            <div className="">
                                <div className="row" data-container="container">
                                    <div
                                        ...
                                        style={{
                                            backgroundImage:
                                                "url(../mt-demo/109600/109604/mt-content/uploads/2020/07/6.jpg)",
                                            backgroundPosition: "top",
                                            backgroundRepeat: "no-repeat",
                                            backgroundSize: "cover"
                                        }}
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                ...
                                                                <p className="moto-text_system_12" style={{ fontSize: '17px', wordSpacing: '2px', }}>
                                                                    Laws are sometimes practiced in ways that differ from how they are written. We suggest that even
                                                                    if a state’s laws appear to favor surrogacy, you should consult with an attorney who practices surrogacy
                                                                    law to ensure that you fully understand what is required in a particular state. Please note the state-by-state
                                                                    page on this site is only updated every few months and changes can happen more often. Please contact us if you have
                                                                    specific concerns regarding a particular state or any other questions.
                                                                    <br /><br />
                            ...
                            <div className='container- fluid'>
                                <div class="card" style={{ padding: '20PX', boxShadow: 'rgba(149, 157, 165, 0.2) 0px 8px 24px' }}>
                                    <div class="card-body">
                                        ...
                                        <b style={{ fontSize: '20px' }}>THE BEST STATES FOR SURROGACY</b>
                                        <p style={{ fontSize: '20PX', marginTop: '10px', fontWeight: 100, wordSpacing: '2PX' }}>

                                            These surrogacy-friendly states permit surrogacies for all parents,
                                            grant pre-birth parentage orders statewide and name the intended parents on the birth certificate.
                                            <br />  <br />
                                            <b style={{ fontSize: '20px' }}>California</b>
                                            <br />
                                            Gestational surrogacy is permitted by statute and backed by additional long-standing supportive case law.
                                            Traditional surrogacy is permitted because it is not prohibited by statute or published case law.
                                            Courts grant pre-birth parentage orders, but they are not effective until the moment of birth.

                                            <br />  <br />
                                            <b style={{ fontSize: '20px' }}> Colorado</b>
                                            <br />

                                            Gestational and traditional surrogacies are
                                            permitted under the Colorado Surrogacy Agreement Act of 2021. Pre-birth parentage orders are granted by the courts.

                                            <br />  <br />
                                            <b style={{ fontSize: '20px' }}>Connecticut</b>
                                            <br />

                                            Gestational surrogacy is condoned by Connecticut General Statute §7-48a, which orders Vital Records to issue birth certificates
                                            naming the intended parents in a gestational surrogacy situation. Courts may grant pre-birth orders. Traditional surrogacy is
                                            permitted because no statute or case law prohibits it; however,
                                            pre-birth orders are not granted, and the surrogate must terminate the biological father’s rights in probate court after birth.

                                            <br />  <br />
                                            <b style={{ fontSize: '20px' }}>District of Columbia</b>
                                            <br />

                                            Gestational surrogacy is permitted by statute, and courts grant pre-birth parentage orders.
                                            The pre-birth order is not effective until after the birth. The same statute also permits traditional surrogacy.
                                            However, an order of parentage in a traditional surrogacy case cannot be issued until at least 48 hours after the birth
                                            <br />  <br />
                                            <b style={{ fontSize: '20px' }}>Delaware</b>
                                            <br />

                                            Gestational surrogacy is permitted under statute if the gestational carrier is “not a parent of a child born as
                                            a result of a gestational carrier agreement.” Pre-birth parentage orders are granted but not enforced until after the birth.
                                            The legality of traditional surrogacy is unclear.
                                            <br />  <br />
                                            <b style={{ fontSize: '20px' }}>Maine</b>
                                            <br />
                                            Maine grants statutory permission to engage in gestational surrogacy. Pre-birth parentage orders are
                                            granted in almost every county. Traditional surrogacy is permitted if the surrogate enters into a contract
                                            with a family member. For someone other than a family member, a formal adoption is required.

                                            <br />  <br />
                                            <b style={{ fontSize: '20px' }}>New Hampshire</b>
                                            <br />
                                            Gestational surrogacy is permitted by statute, and courts grant pre-birth parentage orders.
                                            Traditional surrogacy is permitted, but pre-birth orders are not available.
                                            <br />  <br />
                                            <b style={{ fontSize: '20px' }}>New Jersey</b>
                                            <br />
                                            Gestational surrogacy arrangements and pre-birth orders are enforceable by law under certain conditions.
                                            The New Jersey law that governs gestational surrogacy specifically excludes traditional surrogacy, but it is
                                            permitted if it is uncompensated and if there is no pre-birth agreement to surrender the child. The intended parents
                                            must wait until after birth to adopt the child.
                                            <br />  <br />
                                            <b style={{ fontSize: '20px' }}>Nevada</b>
                                            <br />
                                            Gestational surrogacy is permitted by statute, and courts grant pre-birth parentage orders.
                                            Traditional surrogacy is not included in the statute and is, therefore, legally risky in Nevada.
                                            <br />  <br />
                                            <b style={{ fontSize: '20px' }}>Rhode Island</b>
                                            <br />
                                            Gestational surrogacy has been permitted since 2021. Pre-birth parentage orders are
                                            granted only if at least one of the intended parents is a U.S. resident. Traditional
                                            surrogacy is permitted only when the surrogate is related to the intended parents and
                                            the surrogacy agreement meets all specified requirements, including that at least one of
                                            the intended parents is a U.S. citizen.
                                            <br />  <br />
                                            <b style={{ fontSize: '20px' }}>Vermont</b>
                                            <br />
                                            The Vermont Parentage Act of 2018 permits gestational surrogacy. Pre-birth parentage orders
                                            are granted by the courts. Traditional surrogacy is permitted only because it is not prohibited.
                                            However, it is not covered under the Vermont Parentage Act, and is therefore treated like adoption.
                                            <br />  <br />
                                            <b style={{ fontSize: '20px' }}>Washington</b>
                                            <br />
                                            ...
                                            Traditional surrogacy is permitted, but genetic surrogacy agreements must be validated
                                            by a court before assisted reproduction begins. Pre-birth orders are not granted in
                                            traditional surrogacy cases, but post-birth orders are available after the 48-hour
                                            post-birth period during which the surrogate may change her mind. If the surrogate rescinds
                                            the agreement, the court decides parentage based on the best interests of the child.
                                            <br /><br />
                                            <h1>SURROGACY LAWS BY STATE: STATES WITH POTENTIAL LEGAL HURDLES</h1>
                                            <br /><br />
                                            <b style={{ fontSize: '20px' }}>Idaho</b>
                                            <br />
                                            Idaho permits gestational and traditional surrogacies because it does not prohibit them.
                                            However, case law mandates that a non-genetic parent must adopt the child to be recognized
                                            as the legal parent. Pre-birth parentage orders are not granted.
                                            <br /><br />
                                            <b style={{ fontSize: '20px' }}>New York</b>
                                            <br />
                                            New York permits compensated surrogacy, but only for intended parents who are
                                            New York residents. The courts grant pre-birth parentage orders, but they are not
                                            effective until after the birth. Traditional surrogacy is banned and parties who enter
                                            into such agreements are subject to criminal and civil penalties. Non-compensated
                                            traditional surrogacy agreements are not enforceable, but parentage may be established
                                            through adoption.
                                            <br /><br />
                                            <b style={{ fontSize: '20px' }}>Tennessee</b>
                                            <br />
                                            Gestational and traditional surrogacies are neither expressly allowed nor disallowed.
                                            A Tennessee statute defines surrogacy for purposes of the adoption code. Case law mandates
                                            that the gestational surrogate is named the mother on the birth certificate unless the intended parents
                                            both use their own sperm and egg. If an egg donor is used, the surrogate’s name remains on the birth certificate
                                            until the second parent (intended mother or father) undertakes an adoption. The second parent then replaces the surrogate
                                            on the birth certificate. If the intended mother is the genetic mother, her name goes directly on the birth certificate.
                                            If the intended father is single, he can petition to have the space on the birth certificate for mother changed to read None
                                            or Unknown. Pre-birth parentage orders are granted only if at least one intended parent is genetically related to the child.

                                            The Tennessee Supreme Court ruled that the parental rights of traditional surrogates could not be terminated prior 
                                            to the birth of the child but must be addressed like the parental rights of any woman who gives birth to her genetic child. 
                                            The Court considers the best interests of the child regarding custody. The Court also ruled that while the contract is not binding, 
                                            courts may consider the terms of a surrogacy contract as a factor in the best-interest analysis.
                                            <br /><br />
                                            <b style={{ fontSize: '20px' }}>Virginia</b>
                                            <br />
                                            Gestational surrogacy is permitted under the Assisted Conception Statute for intended 
                                            parents who are a married couple or an unmarried individual. Compensation is limited to
                                             reasonable medical and housing expenses related to the pregnancy. The surrogate cannot give 
                                             consent until 4 days after birth. Pre-birth parentage orders are not granted. While court 
                                             approval of the contract before embryo transfer is available, the process is lengthy and 
                                             expensive. Most intended parents choose to avoid court approval and sign the birth 
                                             certificate paperwork 4 days after delivery, and then file with the Birth Registrar. 
                                             Traditional surrogacy is permitted if all statutory restrictions are met.
                                            <br /><br />
                                            <b style={{ fontSize: '20px' }}>Wyoming</b>
                                            <br />
                                            While the state’s Parentage Act does not authorize or prohibit gestational surrogacy, assisted 
                                            reproduction is subject to the statute. A proceeding to determine parentage may be started before birth, 
                                            but the final order is not issued until after the birth. Likewise, traditional surrogacy is neither
                                             authorized nor prohibited, but a traditional surrogate is considered a birth mother. A birth mother 
                                             cannot terminate her rights to the child until after the birth.
                                            <br /><br />
                                            <h1>SURROGACY LAWS BY STATE: CONTRACTS ARE VOID AND UNENFORCEABLE IN THESE STATES</h1>
                                            <br/>
                                            <b style={{ fontSize: '20px' }}>Wyoming</b>
                                            <br />
                                            While the state’s Parentage Act does not authorize or prohibit gestational surrogacy, assisted 
                                            ...
                                            but the final order is not issued until after the birth. Likewise, traditional surrogacy is neither
                                             ...
                                             cannot terminate her rights to the child until after the birth.
                                            <br /><br />
                                            <b style={{ fontSize: '20px' }}>Arizona</b>
                                            <br />
                                            Surrogacy contracts are prohibited in Arizona by a statute stating that no 
                                            person may enter into or assist in creating a surrogacy contract. Gestational
                                             surrogacy is practiced in the state and some courts may grant pre-birth orders,
                                              but the surrogacy contracts remain unenforceable. 
                                            <br /><br />
                                            <b style={{ fontSize: '20px' }}>Indiana</b>
                                            <br />
                                            While surrogacy contracts are void and unenforceable, the practice continues.
                                             Some courts have even granted pre-birth orders establishing the rights of intended
                                              parents in gestational surrogacy situations. The courts have refused to grant pre-birth
                                               orders for traditional surrogacy; the intended parents are required to go through a 
                                               post-birth adoption procedure.
                                            <br /><br />
                                            <h1>SURROGACY LAWS BY STATE: STATES THAT PROHIBIT SURROGACY CONTRACTS</h1>
                                            <br />
                                            
                                            <b style={{ fontSize: '20px' }}>Louisiana</b>
                                            <br />
                                            Gestational surrogacy is limited to heterosexual married couples using their 
                                            own gametes and places strict requirements on surrogacy arrangements, including a 
                                            prohibition on compensation. Entering into a surrogacy agreement that is not sanctioned 
                                            by the 2016 law carries civil and criminal penalties. Pre-birth orders are granted under
                                             limited circumstances. Contracts that compensate a traditional surrogate are void and 
                                             unenforceable.
                                            <br /><br />
                                            <b style={{ fontSize: '20px' }}>Michigan</b>
                                            <br />
                                            All surrogacy contracts and agreements are “void and unenforceable as contrary to public policy.”
                                             Plus, surrogacy contracts involving compensation are subject to criminal penalties. Pre-birth 
                                             orders are not granted if compensation or living expenses are involved; they are granted only in 
                                             “compassionate” cases, meaning that one of the intended parents has a genetic tie to the child, 
                                             the intended parents are married, and the intended parents and surrogate each have legal representation.
                                            <br /><br />
                                            <b style={{ fontSize: '20px' }}>Nebraska</b>
                                            <br />
                                            Nebraska law makes compensated surrogacy contracts unenforceable, but it declares that the biological father is 
                                            the sole legal parent. Only uncompensated surrogacy is allowed but the underlying contract is void and unenforceable.
                                             Nebraska grants no pre-birth parentage orders. Post-birth orders are granted only when the surrogate is not compensated. 
                                             The surrogate is named on the birth certificate with the biological father, and then the couple must return to their 
                                             home state to pursue
                                             a stepparent adoption for the intended mother. Only then will Nebraska amend the birth certificate.
                                            <br />
...
export default Surrogacybystate
