                                        ...
                                        <div class="card" style={{ padding: '20PX', boxShadow: 'rgba(149, 157, 165, 0.2) 0px 8px 24px' }}>
                                            <div class="card-body">
                                                ...
                                                <p style={{ fontSize: '17PX', marginTop: '10px', fontWeight: 100, wordSpacing: '2PX' }}>
                                                    ...
                                                    How do surrogates get pregnant? What is it like being a surrogate?
                                                    We understand that before you make the decision to undertake this amazing journey, you have many questions.
                                                    <br />  <br />
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                <h1 className="moto-text_system_7">
                                                                    GET ANSWERS TO YOUR SURROGACY FAQS
                                                                </h1>
                                                                ...
                                                                <p className="moto-text_system_12" style={{ fontSize: '17px', wordSpacing: '2px', }}>
                                                                    How do surrogates get pregnant? What is it like being a surrogate? We understand that before you make the
                                                                    decision to undertake this amazing journey, you have many questions. Below are answers to the surrogacy FAQs we’re asked most
                                                                    often by potential surrogates.
                                                                    If you have additional questions, please feel free to get in touch us. We’re happy to help!
                                                                    <br /><br />
                                ...
                                <div class="card" style={{ padding: '20PX', boxShadow: 'rgba(149, 157, 165, 0.2) 0px 8px 24px' }}>
                                    <div class="card-body">
                                        ...
                                        <p style={{ fontSize: '20PX', marginTop: '10px', fontWeight: 100, wordSpacing: '2PX' }}>
                                            ...
                                            can expect. Because we’ve been there ourselves,
                                            we’re fully prepared to guide you through your journey and answer any surrogacy questions you may have with compassion and expertise.
                                            <br />  <br />
                                            <b style={{ fontSize: '20px' }}> ONCE I AM PREGNANT, WHERE WILL I RECEIVE MEDICAL CARE AND DELIVER THE BABY?</b>
                                            <br />  <br />

                                            Typically, you see your current OB doctor during your pregnancy. If you need a new OB doctor, we will
                                            provide you with a recommendation. You will be able to deliver at a hospital that is local to you so long as it’s
                                            approved by your insurance provider; this will most likely be where you delivered your own children.
                                            <br />  <br />
                                            <b style={{ fontSize: '20px' }}> ONCE I AM PREGNANT, WHERE WILL I RECEIVE MEDICAL CARE AND DELIVER THE BABY?</b>
                                            <br />  <br />

                                            Typically, you see your current OB doctor during your pregnancy. If you need a new OB doctor,
                                            we will provide you with a recommendation. You will be able to deliver at a hospital that is local
                                            to you so long as it’s approved by your insurance provider; this will most likely be where you delivered your own children.

                                            <br />  <br />
                                            <b style={{ fontSize: '20px' }}> WHERE IS THE IVF CLINIC I WILL BE USING LOCATED?</b>
                                            <br />  <br />

                                            We work with IVF clinics in various cities in California. Most of these clinics are in San Diego or Los Angeles.
                                            If long-distance travel is required, you will be compensated for your travel expenses. If traveling,
                                            you will make these trips only during the initial stages of the fertility treatment and pregnancy. Once you are near the
                                            completion of the first trimester, the IVF doctor will release you to your local OB doctor.

                                            <br />  <br />
                                            <b style={{ fontSize: '20px' }}>WILL MY HUSBAND’S AND MY NAMES BE ON THE BIRTH CERTIFICATE?</b>
                                            <br />  <br />

                                            Through California’s pre-birth judgment, the intended parents have full parental rights to the child and
                                            their names go on the birth certificate — not the surrogate or her spouse.
                                            <br />  <br />
                                            <b style={{ fontSize: '20px' }}>WILL I HAVE ANY GENETIC RELATIONSHIP TO THE CHILD(REN) BORN?</b>
                                            <br />  <br />

                                            No. As a gestational surrogate, you will be using the eggs from either the intended mother or an egg donor.
                                            You will have no genetic relation to the child(ren).
                                            <br />  <br />
                                            <b style={{ fontSize: '20px' }}>WHAT IS A SURROGATE?</b>
                                            <br />  <br />

                                            A surrogate is a woman who agrees to carry a child(ren) for another person or couple. There are two types of surrogates:
                                            traditional and gestational.

                                            Most of our surrogates are gestational surrogates, which is the most common type. A gestational surrogate is not genetically related to the child(ren)
                                            she is carrying for the intended parent(s). The eggs are retrieved from the intended mother or an egg donor, fertilized with sperm from the intended father or a sperm donor, and then transferred to the surrogate’s womb.
