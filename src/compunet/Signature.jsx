                        ...
                        <div className="container">
                            <div className='row'>
                                ...
                                <div className='col-lg-12'>
                                    ...
                                    <label>I agree to allow Possible surrogacy center to share the photos/videos I have provided for my surrogate profile to prospective intended parents for the purpose of matching. I understand that my surrogate profile (including the photos within) will also be shared with relevant surrogacy professionals as necessary to facilitate the surrogacy journey, such as the IVF clinic and mental health professional. I understand the photos/videos I have provided for my surrogate profile will NOT be shared on ISC’s social media or website in order to protect my privacy. Possible surrogacy center respects the privacy of all surrogates and intended parents and does not share photos/videos/posts of anyone without express prior written consent. Surrogates and intended parents may choose to occasionally share photos/videos with ISC staff or tag us within their social media posts, this is completely voluntary and not required
